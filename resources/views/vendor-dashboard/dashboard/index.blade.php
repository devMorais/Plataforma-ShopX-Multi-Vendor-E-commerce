    ...
    <div class="container-xl">
        @if (auth('web')->user()->kyc?->status == 'pending')
            <div class="alert alert-important alert-warning alert-dismissible" role="alert">
                ...
                <div>
                    <h4 class="alert-heading">Sua verificação KYC está pendente</h4>
                    <div class="alert-description">Aguarde a aprovação da sua verificação KYC pelo administrador.</div>
                </div>
        ...
        @if (auth('web')->user()->kyc?->status == 'rejected' || auth('web')->user()->kyc?->status == null)
            <div class="alert alert-important alert-danger alert-dismissible" role="alert">
                ...
                <div class="w-100">
                    <h4 class="alert-heading">Envie sua verificação KYC</h4>
                    <div class="alert-description d-flex justify-content-between align-items-center ">
                        <span>Envie sua verificação KYC para começar.</span>
                        <div>
                            <a href="{{ route('kyc.index') }}" class="btn btn-6 btn-outline-light">Enviar KYC</a>
                        </div>
                    </div>
                </div>
                <a class="btn-close" data-bs-dismiss="alert" aria-label="close"></a>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">Total de produtos digitais</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">Total de produtos físicos</div>
                                    </div>
                                </div>
                            </div>
                        </div>
