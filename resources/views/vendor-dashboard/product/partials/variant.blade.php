<div class="accordion-item">
    <div class="accordion-header">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            ...
            {{ $variant->name }} @if($variant->is_default == 1) <span class="badge bg-primary text-white">default</span> @endif  @if($variant->is_active == 1) <span class="badge bg-success text-white">Ativo</span> @endif
            ...
            <form action="" class="variant-form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card my-3">
                            <div class="card-body">
                                <label for="" class="form-label">Status do estoque</label>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex gap-2">
                            <label class="form-check form-switch form-switch-3">
                                ...
                                <span class="form-check-label">Padrão</span>
                            </label>
                ...
                <div class="mt-2">
                    <button class="btn  btn-success variant-save-btn" type="submit">Salvar</button>
                </div>
            </form>
        </div>
    </div>
