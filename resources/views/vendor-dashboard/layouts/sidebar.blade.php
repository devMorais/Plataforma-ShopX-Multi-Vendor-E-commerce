                  ...
                  <ul class="navbar-nav pt-lg-3">
                                  ...
                                  <div class="dropdown-menu-column">
                                      <div class="dropend">
                                          <a class="dropdown-item {{ setActive(['vendor.products.*', 'vendor.digital-products.edit'], 'active') }}"
                                              href="{{ route('vendor.products.index') }}">Produtos</a>
                                      </div>
                      ...
                      <li class="nav-item">
                          <a class="nav-link {{ setActive(['vendor.store-profile.index'], 'active') }}"
                              ...
                              <span class="nav-link-title"> Perfil da loja </span>
                          </a>
                      </li>
          ...
          <div class="container-xl">
              ...
              <div class="navbar-nav flex-row order-md-last">
                  ...
                  <div class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                          <a href="{{ route('vendor.store-profile.index') }}" class="dropdown-item">Perfil da loja</a>
                          <div class="dropdown-divider"></div>
                          <a href="{{ route('vendor.profile.index') }}" class="dropdown-item">Configurações</a>
