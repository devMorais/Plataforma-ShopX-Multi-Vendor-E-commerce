        ...
        <div class="card">
            <div class="card-header d-print-none">
                ...
                <div class="card-actions">
                    <a href="{{ route('vendor.orders.index') }}" class="btn btn-primary">Voltar</a>
                </div>
            </div>
                        ...
                        <div class="container-xl">
                            <div class="card card-lg">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class="h3">Informações de cobrança</p>
                                            <address>
                                                @php
                                        ...
                                        <div class="col-6 text-end">
                                            <p class="h3">Informações de entrega</p>
                                            <address>
                                                @if ($shippingInfo)
                                        ...
                                        <div class="col-12 my-5">
                                            ...
                                            <span>Forma de pagamento: {{ $order->payment_method }}</span>
