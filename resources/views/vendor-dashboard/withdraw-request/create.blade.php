    ...
    <div class="container-xl">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-secondary">Saldo pendente</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-secondary">Total sacado</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Create Solicitação de saque</h3>
                <div class="card-actions">
                    <a href="{{ route('vendor.withdraw-requests.index') }}" class="btn btn-primary">Voltar</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('vendor.withdraw-requests.store') }}" method="POST" class="withdraw-method-form">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label required">Valor do saque</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label required">Método de saque</label>
            ...
            <div class="card-footer text-end">
                <button class="btn btn-primary mt-3" onclick="$('.withdraw-method-form').submit()">Criar</button>
            </div>
        </div>
    </div>
    </div>
