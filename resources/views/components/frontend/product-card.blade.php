    ...
    <div class="product-cart-wrap mb-30">
        <div class="product-img-action-wrap">
            ...
            <div class="product-action-1">
                ...
                <a aria-label="Adicionar à Lista de Desejos" class="action-btn wishlist-btn" data-id="{{ $product->id }}" href="">
                ...
                <a href="{{ route('products.show', $product->slug) }}" aria-label="Visualização rápida" class="action-btn" ><i
                        class="fi-rs-eye"></i></a>
            </div>
                ...
                <div class="add-cart">
                    <a class="add add_to_cart" data-id="{{ $product->id }}"
                        data-modal="{{ $product->primaryVariant ? 'true' : 'false' }}" href=""><i
                            class="fi-rs-shopping-cart mr-5"></i>Adicionar ao carrinho</a>
                </div>
                @endif
            </div>
        </div>
