                          ...
                          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                              <div class="card">
                                  ...
                                  <div class="list-group list-group-flush list-group-hoverable">
                                      ...
                                      <div class="list-group-item">
                                          <div class="row align-items-center">
                                              ...
                                              <div class="col text-truncate">
                                                  <a href="#" class="text-body d-block">Exemplo 4</a>
                                  ...
                                  <div class="card-body">
                                      <div class="row">
                                          <div class="col">
                                              <a href="#" class="btn btn-2 w-100"> Arquivar todas </a>
                                          </div>
                                          <div class="col">
                                              <a href="#" class="btn btn-2 w-100"> Marcar todas como lidas </a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                      ...
                      @if (hasPermission(['KYC Management']))
                          <li class="nav-item dropdown {{ setActive(['admin.kyc.*']) }}">
                              <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                                  ...
                                  <span class="nav-link-title"> Solicitações de KYC </span>
                              </a>
                      ...
                      @if (hasPermission(['Category Management', 'Tags Management', 'Brand Management']))
                          <li
                              ...
                              <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                                  ...
                                  <span class="nav-link-title"> Gerenciar produtos </span>
                              </a>
                              <div
                      ...
                      @if (hasPermission(['Section Management']))
                          <li
                              ...
                              <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                                  ...
                                  <span class="nav-link-title"> Gerenciar seções </span>
                              </a>
                              <div
                                  ...
                                  <div class="dropdown-menu-columns">
                                      ...
                                      <div class="dropdown-menu-column">
                                          <a class="dropdown-item {{ setActive(['admin.popular-categories.*']) }}"
                                              ...
                                              Produtos de categorias populares
                                          </a>
                                      </div>
                                      <div class="dropdown-menu-column">
                      ...
                      @if (hasPermission(['Subscriber Management']))
                          <li class="nav-item">
                              <a class="nav-link {{ setActive(['admin.subscribers.*']) }}"
                                  ...
                                  <span class="nav-link-title"> Inscritos </span>
                              </a>
                          </li>
                      @endif
                      ...
                      @if (hasPermission(['Withdraw Management']))
                          <li
                              ...
                              <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                                  ...
                                  <span class="nav-link-title"> Saques </span>
                              </a>
                              <div
                      ...
                      @if (hasPermission(['Page Management']))
                          <li class="nav-item">
                              <a class="nav-link {{ setActive(['admin.custom-pages.*']) }}"
                                  ...
                                  <span class="nav-link-title"> Construtor de páginas </span>
                              </a>
                          </li>
                      @endif
                      @if (hasPermission(['Advertisement Management']))
                          <li class="nav-item {{ setActive(['admin.banners.*']) }}">
                              <a class="nav-link" href="{{ route('admin.banners.index') }}">
                                  ...
                                  <span class="nav-link-title"> Publicidade </span>
                              </a>
                          </li>
                      @endif
                      ...
                      @if (hasPermission(['Payment Setting']))
                          <li class="nav-item">
                              <a class="nav-link {{ setActive(['admin.payment-settings.*']) }}"
                                  ...
                                  <span class="nav-link-title"> Configurações de pagamento </span>
                              </a>
                          </li>
                      @endif
                      ...
                      @if (hasPermission(['Role Management', 'Role User Management']))
                          <li class="nav-item dropdown {{ setActive(['admin.role.*', 'admin.role-users.*']) }}">
                              <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                                  ...
                                  <span class="nav-link-title"> Gestão de Acesso </span>
                              </a>
                              <div
                      ...
                      @if (hasPermission(['Settings Management']))
                          <li class="nav-item">
                              <a class="nav-link {{ setActive(['admin.settings.*']) }}"
                                  ...
                                  <span class="nav-link-title"> Apagar banco de dados </span>
                              </a>
                          </li>
                      @endif
              ...
              <div class="navbar-nav flex-row order-md-last">
                  ...
                  <div class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                          ...
                          <div class="dropdown-divider"></div>
                          <a href="{{ route('admin.settings.index') }}" class="dropdown-item">Configurações</a>
                          <a onclick="event.preventDefault();
                                $('.logout-form').submit();"
                              href="" class="dropdown-item">Sair</a>
