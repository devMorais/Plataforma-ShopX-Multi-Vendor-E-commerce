...
@section('contents')
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><span id="category-title">Criar categoria</span></div>
                    <div class="card-body">
                        <form action="" id="category-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label for="" class="form-label">Ícone <span
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-2">
                                        <label for="" class="form-label">Imagem <span
                                                class="text-danger"></span></label>
                            ...
                            <div class="mb-2">
                                <label for="" class="form-label">Categoria pai <span
                                        class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-2">
                                        <label class="form-check form-switch form-switch-3">
                                            <input class="form-check-input" type="checkbox" name="is_featured"
                                                id="is_featured">
                                            <span class="form-check-label">em destaque</span>
                                        </label>
                                    </div>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="button" class="btn btn-danger d-none" id="btn-delete">Excluir</button>
    ...
    <script>
        ...
        $(function() {
            ...
            function clearForm() {
                ...
                $('#category-title').text('Criar categoria');
                $('#name').val('');
                $('#slug').val('');
                $('#parent_id').val('');
