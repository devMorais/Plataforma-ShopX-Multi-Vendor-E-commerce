    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Todos os banners</h3>
                ...
                <div class="d-flex align-items-start">
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="true">Seção de banner Um</button>

                        <button class="nav-link" id="v-pills-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home-two"
                            type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Banner inicial
                            section Two</button>
