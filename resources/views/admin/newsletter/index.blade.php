                            ...
                            <div class="accordion-body">
                               <form action="{{ route('admin.newsletter.send') }}" method="POST" >
                                ...
                                <div class="from-group mt-3">
                                    ...
                                    <textarea name="message" id="editor" class="form-control" placeholder="Mensagem"></textarea>
                                    <x-input-error for="message" class="mt-2" :messages="$errors->get('message')" />
                                </div>
                                <div class="from-group mt-3">
                                    <button class="btn btn-primary" type="submit">Enviar newsletter</button>
                                </div>
                               </form>
                            </div>
                        </div>
                                ...
                                @forelse($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge bg-danger-lt">Não verificado</span>
                                            @endif
                                        </td>
