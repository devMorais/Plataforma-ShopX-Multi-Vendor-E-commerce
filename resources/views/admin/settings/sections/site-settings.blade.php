...
@section('settings_contents')
    <div class="card-body">
        ...
        <form action="{{ route('admin.site-settings.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    <div class="form-label">Site Descrição curta</div>
                ...
                <div class="col-md-12">
                    <div class="form-label">Endereço do site</div>
                ...
                <div class="col-md-12">
                    <div class="form-label">Horário de atendimento</div>
                ...
                <div class="col-md-12">
                    <div class="form-label required">Direitos autorais</div>
