    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Atualizar seção de produtos</h3>
            ...
            <div class="card-body">
                <form action="{{ route('admin.product-sections.store') }}" method="POST" class="coupon-form">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">Categoria da seção Um</label>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">Categoria da seção Dois</label>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">Categoria da seção Três</label>
