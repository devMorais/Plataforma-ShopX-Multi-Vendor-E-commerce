    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Atualizar itens da oferta</h3>
            ...
            <div class="card-body flash_sell_tags">
                <form action="{{ route('admin.flash-sales.store') }}" method="POST" class="coupon-form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label required">Início da promoção</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label required">Fim da promoção</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label required">Produtos em promoção</label>
