            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select name="attribute_type" class="form-control main-type" id="">
                        ...
                        <option value="color" @selected($attribute->type == 'color')>Cor</option>
                    </select>
                </div>
            </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Rótulo" value="{{ $value->value }}">
                                <span class="review-row-btn ms-2"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
