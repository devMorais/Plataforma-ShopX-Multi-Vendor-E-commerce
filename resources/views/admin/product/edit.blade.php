            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card mb-3">
                        ...
                        <h3 class="card-title">Criar funções</h3>
                        <div class="card-actions">
                            <a href="{{ route('admin.role.index') }}" class="btn btn-primary">Voltar</a>
                        </div>
                    </div> --}}
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label required">Descrição curta</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-check">
                                                ...
                                                <span class="form-check-label">Gerenciar estoque</span>
                                            </label>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-check">
                                                        ...
                                                        <span class="form-check-label">Esgotado</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Atributos do produto</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Variações do produto</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3 class="card-title">Status de aprovação</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="approved_status" class="form-control" id="">
                                        <option @selected($product->approved_status == 'pending') value="pending">Pendente</option>
                                        <option @selected($product->approved_status == 'approved') value="approved">Aprovado</option>
                                        <option @selected($product->approved_status == 'rejected') value="rejected">Rejeitado</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="status" class="form-control" id="">
                                        <option @selected($product->status == 'active') value="active">Ativo</option>
                                        <option @selected($product->status == 'inactive') value="inactive">Inativo</option>
                                        <option @selected($product->status == 'draft') value="draft">Rascunho</option>
                                    </select>
                                    <x-input-error :messages="$errors->get('status')" class="mt-2" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="store" class="form-control select2" id="">
                                        <option value="published">Selecione uma loja</option>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-check">
                                        ...
                                        <span class="form-check-label">Em Alta</span>
                                    </label>
                                    <label class="form-check">
...
@push('scripts')
    ...
    <div id="${collapseId}" class="accordion-collapse collapse" data-bs-parent="#accordion-default" style="">
        <div class="accordion-body">
            ...
            <div class="mt-2">
                <button class="btn btn-sm btn-primary add-row-btn" type="button">Adicionar linha</button>
                <button class="btn btn-sm btn-success save-btn" type="button">Salvar</button>
            </div>
        </div>
        </form>
    </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Rótulo">
                                <span class="review-row-btn ms-2"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
            ...
            $(document).on('change', '.main-type', function() {
                ...
                labels.forEach(label => {
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Rótulo" value="${label}">
                                <span class="review-row-btn ms-2"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
