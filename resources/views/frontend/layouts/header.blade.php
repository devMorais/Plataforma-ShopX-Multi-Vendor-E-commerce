            ...
            <div class="row align-items-center">
                <div class="col-xxl-3 col-xl-4 col-lg-7">
                    <div class="header-info">
                        <ul>
                            ...
                            <li><a href="{{ route('wishlist.index') }}">Lista de Desejos</a></li>
                            <li><a href="{{ route('track.order.index') }}">Rastrear Pedido</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-5">
                    <div class="header-info header-info-right">
                        <ul>
                            <li>Precisa de ajuda? Ligue: <strong class="text-brand">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="{{ route('dashboard') }}"><i
                                                        class="fi fi-rs-user mr-10"></i>Painel</a>
                                            </li>
                                            <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="{{ route('login') }}"><i
                                                        class="fi fi-rs-user mr-10"></i>Entrar</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('register') }}"><i
                                                        class="fi fi-rs-user mr-10"></i>Cadastrar</a>
                                            </li>
                ...
                <div class="header-nav d-none d-lg-flex">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                <li>
                                    <a class="active" href="{{ url('/') }}">Início</a>
                                </li>
