                        ...
                        <div class="newsletter_bg" style="background:url({{ asset('assets/frontend/dist/imgs/banner/banner-9.png') }});">
                            <div class="position-relative newsletter-inner">
                                <div class=" newsletter-content">
                                    <h2 class="mb-20">Tenha Estilo em Casa — Compre <br> as Últimas Tendências Online</h2>
                                    <p class="mb-45">Comece suas compras do dia com <span
                                            class="text-brand">ShopX</span>
                                    </p>
                                    <form class="form-subcriber d-flex">
                                        @csrf
                                        <input type="email" placeholder="Seu endereço de e-mail" name="email" />
                        ...
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-contact.svg') }}"
                                        alt="" /><strong>Ligue:</strong><span>{{ config('settings.site_phone') }}</span></li>
                                <li><img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-email-2.svg') }}"
                                        alt="" /><strong>E-mail:</strong><span>{{ config('settings.site_email') }}</span></li>
                                <li><img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-clock.svg') }}"
                                        alt="" /><strong>Horário:</strong><span>{{ config('settings.site_hours') }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-sm-6 col-lg-3">
                        <div class="footer-link-widget wow animate__animated animate__fadeInUp"
                            ...
                            <ul class="footer-list mb-sm-5 mb-md-0">
                                ...
                                <li><a href="{{ route('register') }}">Seja um Vendedor</a></li>
                                <li><a href="{{ route('contact.index') }}">Fale Conosco</a></li>
                                <li><a href="{{ route('flash-sales.index') }}">Ofertas Relâmpago</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-sm-6 col-lg-3">
                        <div class="footer-link-widget wow animate__animated animate__fadeInUp"
                            data-wow-delay=".2s">
                            <h4 class="widget-title">Mais Links</h4>
                            <ul class="footer-list mb-sm-5 mb-md-0">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    <div class="hotline d-lg-inline-flex">
                        ...
                        <p>{{ config('settings.site_phone') }}<span>Central de Suporte 24/7</span></p>
                    </div>
                </div>
