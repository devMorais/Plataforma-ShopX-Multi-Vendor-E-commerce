...
@section('contents')
    ...
    <x-frontend.breadcrumb :items="[['label' => 'Início', 'url' => '/'], ['label' => 'Carrinho']]" />
    <div class="container mb-60 mt-55">
        <div class="row">
            <div class="col-lg-8 mb-40">
                <h1 class="heading-2 mb-10">Your Cart</h1>
                <div class="d-flex flex-wrap justify-content-between">
                    <h6 class="text-body">Há <span class="text-brand">{{ cartCount() }}</span> produtos no seu carrinho
                    </h6>
                        ...
                        <tbody class="cart-items">
                            @forelse($cartItems as $cartItem)
                                <tr class="">
                                    ...
                                    @else
                                        <td colspan="3">
                                            <h4 class="text-brand">Esgotado</h4>
                                        </td>
                                    @endif
