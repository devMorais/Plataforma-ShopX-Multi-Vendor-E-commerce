...
@endphp
    <x-frontend.breadcrumb :items="[['label' => 'Início', 'url' => '/'], ['label' => 'Contato']]" />
                                ...
                                <div class="row mb-60">
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        <div class="contact_box">
                                            ...
                                            <p><b>E-mail:</b> {{ $contactSection?->email_one ?? 'N/A' }}</p>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        <div class="contact_box">
                                            ...
                                            <p><b>E-mail:</b> {{ $contactSection?->email_two ?? 'N/A' }}</p>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        <div class="contact_box">
                                            ...
                                            <p><b>E-mail:</b> {{ $contactSection?->email_three ?? 'N/A' }}</p>
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-12">
                                        <div class="contact-from-area padding-20-row-col">
                                            ...
                                            <h2 class="mb-10">Fale conosco</h2>
