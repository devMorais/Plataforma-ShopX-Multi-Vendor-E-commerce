...
@section('contents')
    <x-frontend.breadcrumb :items="[['label' => 'Início', 'url' => '/'], ['label' => 'Produtos']]" />
                    ...
                    <div class="sort-by-product-area">
                        {{-- <div class="sort-by-cover mr-10">
                            <div class="sort-by-product-wrap">
                                <div class="sort-by">
                                    <span><i class="fi-rs-apps"></i>Exibir:</span>
                                </div>
                        ...
                        {{-- <div class="sort-by-cover">
                            <div class="sort-by-product-wrap">
                                ...
                                <div class="sort-by-dropdown-wrap">
                                    <span> Destaque <i class="fi-rs-angle-small-down"></i></span>
                                </div>
                            </div>
                            <div class="sort-by-dropdown">
                                <ul>
                                    <li><a class="active" href="#">Destaque</a></li>
                                    <li><a href="#">Price: Low to High</a></li>
                                    <li><a href="#">Price: High to Low</a></li>
                                    <li><a href="#">Release Date</a></li>
                                    <li><a href="#">Avaliação média</a></li>
                                </ul>
                            </div>
                        </div> --}}
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        //             complete: function() {
        //                 self.html('<i class="fi-rs-shopping-cart mr-5"></i>Adicionar ao carrinho');
        //             }
        //         })
        //     })
        ...
        //                     <span class="current-price text-brand">Esgotado</span>
        //                 </div>`
