...
@section('contents')
    <x-frontend.breadcrumb :items="[['label' => 'Início', 'url' => '/'], ['label' => 'Lista de Desejos']]" />
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="mb-50">
                    ...
                    <h6 class="text-body">Há <span class="text-brand">5</span> products in this list</h6>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr class="pt-30">
                                ...
                                <td class="text-center detail-info" data-title="Stock">
                                    ...
                                    @else
                                    <span class="stock-status in-stock mb-0"> Esgotado </span>
                                    @endif
                                </td>
