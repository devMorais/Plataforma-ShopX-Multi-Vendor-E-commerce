        ...
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                <div class="d-flex justify-content-between">
                    <h6 class="text-body">Há <span class="text-brand">{{ cartCount() }}</span> produtos no seu carrinho</h6>
                </div>
            </div>
        </div>
                                ...
                                <div class="wsus__shipping_address_item">
                                    ...
                                    <div class="wsus__shipping_mail_address">
                                        ...
                                        @if ($address->is_default == 1)
                                            <span class="text-success">(Padrão)</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                ...
                <div class="wsus__billing_summary">
                    ...
                    <div class="wsus__total_price">
                        ...
                        {{-- <form method="post" class="apply-coupon mb-10">
                                ...
                                <button class="btn  btn-md" name="login">Aplicar cupom</button>
                            </form> --}}
                        ...
                        <p>Frete <span class="">$ <span class="shipping_charge">00.00</span></span></p>
