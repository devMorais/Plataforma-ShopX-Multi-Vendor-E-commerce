...
@section('contents')
    <x-frontend.breadcrumb :items="[['label' => 'Início', 'url' => '/'], ['label' => 'Painel']]" />
                                ...
                                <ul class="nav flex-column" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link {{ setActive(['dashboard']) }}"
                                            href="{{ route('dashboard') }}"><i
                                                class="fi-rs-settings-sliders mr-10"></i>Painel</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ setActive(['purchased.*']) }}"
                                            href="{{ route('purchased.products') }}"><i
                                                class="fi-rs-shopping-bag mr-10"></i>Produtos comprados</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ setActive(['track.order.*']) }}"
                                            href="{{ route('track.order.index') }}"><i
                                                class="fi-rs-shopping-cart-check mr-10"></i>Rastrear seu pedido</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ setActive(['wishlist.index']) }}" href="{{ route('wishlist.index') }}">
                                            <i class="fi fi-rs-star mr-10"></i> Lista de Desejos
                                        </a>
                                    </li>
                                    <li class="nav-item">
